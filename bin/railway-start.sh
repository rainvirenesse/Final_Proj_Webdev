...
PORT="${PORT:-8000}"
echo "==> Starting PHP built-in server on 0.0.0.0:${PORT} (Router: public/router.php)"
# Without router.php, /assets/ returns 404 because index.php tries to route them dynamically.
